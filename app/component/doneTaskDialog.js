...
class DoneTaskDialog extends React.Component {

    doneTaskFunction() {
        const {doneTask, close} = this.props;
        doneTask();
        close();
    }

    render() {
        const {open, close, task, doneTask} = this.props;
        console.log(task);
                ...
                <View style={styles.modalParent}>
                    <View style={styles.modalContainer}>
                        <View style={styles.titleContainer}>
                            <Text style={styles.addText}>Done Task</Text>
                        ...
                        <View style={styles.msgTextContainer}>
                            <Text style={styles.msgText}>
                                Are you sure you want to done {task}  ?
                            </Text>
                        </View>               
                        <View style={styles.buttonContainer}>
                            ...
                            <TouchableHighlight  onPress={this.doneTaskFunction.bind(this)} style={{borderRadius: 10}}>                                
                                <View style={styles.button}>
                                    <Icon name="check" size={30} color="#6c5f5b" />
